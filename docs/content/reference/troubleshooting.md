...
Most of these come down to network reality or how ssi serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

ssi rate-limits like any public site. ssi already paces
...
Where a surface is gated, ssi reads a cookie or token you supply
...
`ssi`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what ssi actually did
